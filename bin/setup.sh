...
fess_plugins="
fess-script-groovy:14.15.0
fess-webapp-multimodal:14.15.0
"
...
mkdir -p ${base_dir}/data/clip_server/cache/clip
mkdir -p ${base_dir}/data/clip_server/cache/jina
...
if [ $(uname -s) = "Linux" ] ; then
  ...
  sudo chown -R 1000 ${base_dir}/data/clip_server/cache/clip
  sudo chown -R 1000 ${base_dir}/data/clip_server/cache/jina
fi
